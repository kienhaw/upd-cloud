...
export default (props) => {
  const { fields, remove, item, control, errors, gap, getValues } = props;
            ...
            {item.child.map((x, i) => (
              <Fragment key={i}>
                ...
                {item.single ? (
                  ...
                  <FormGroup elem={elem} index={index} parent={item} item={x} control={control} errors={errors} getValues={getValues} />
                )}
              </Fragment>
            ))}
          </Row>
